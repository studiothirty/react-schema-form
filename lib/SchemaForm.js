...
var SchemaForm = (function (_React$Component) {
    ...
    _createClass(SchemaForm, [{
        ...
        value: function builder(form, model, index, onChange, mapper) {
            ...
            console.log(_reactDomServer2['default'].renderToString(_react2['default'].createElement(Field, { model: model, form: form, key: index, onChange: onChange, mapper: mapper, builder: this.builder })));
